...
<div class="actions text-right">
    ...
    <?php if($role == 'admin'): ?>
    <a href="<?= base_url(user_data('Title')[1]);?>/observations/new" class="btn btn-primary">Add New</a>
    <a href="<?= str_replace('observations','observations/find',page_url("export=true")) ?>" class="btn btn-success">Export</a>
...
<?= card('end');?>
<script defer src="<?= base_url(UI['main']);?>/ag-grid/observations.js"></script>