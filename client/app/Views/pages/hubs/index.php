...
foreach ($hubs as $x) if (@$_GET['category'] == $x['id']) $current = $x;
$current['content'] = json_decode($current['content']);
?>
<style>
    .main-panel .page-header,.hide {display: none !important;}
</style>

<h3><?= @$current['content'][0];?></h3>
