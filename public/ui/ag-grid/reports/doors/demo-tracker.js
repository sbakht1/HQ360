  ...
  const gridOptions = {
      columnDefs: [
        ...
        }},
        {
          ...
          cellRenderer: params => {
              let cell = '';
              return cell + `<a href="${window.app.url+'/uploads/'+params.data.file}" download="Launch Demo Tracker ${params.data.date}" class="btn btn-sm btn-primary">Download</a>`;
          }
        }
      ],
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      fetch(window.app.url+'/'+window.app.role+'/reports/doors/find/demo-tracker?'+config)
