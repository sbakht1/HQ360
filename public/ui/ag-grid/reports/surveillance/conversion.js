document.addEventListener('DOMContentLoaded', function () {
    ...
    let cols = ["District","Employee_Name","Store_Name","Total_Customer_Count","Total_Opps","Activation","Activation_Closing_Rate","Upgrade","SPs","Gross_Profit","Accessories_Profit","APO","Breaktime"];
    ...
    const gridOptions = {
      ...
      let rep_url = `${url}/${role}/reports/surveillance/find/conversion/?${config}`;
      fetch(rep_url)
